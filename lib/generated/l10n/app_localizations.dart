...
abstract class AppLocalizations {
  ...
  /// No description provided for @pressToSearch.
  ///
  /// In en, this message translates to:
  /// **'Press the search button to find places'**
  String get pressToSearch;
  ...
  /// No description provided for @noPlaceSelected.
  ///
  /// In en, this message translates to:
  /// **'No place selected'**
